...
if (isset($_SESSION['username'])) {
    ...
    $id=$_GET['id'];
    $sel="SELECT * FROM `authors` WHERE author_id='$id'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "UPDATE `authors` SET `name`='$name',`biography`='$biography' WHERE `author_id`='$id'";
        $query_run = mysqli_query($conn, $query);
        if ($query_run) {
            $_SESSION['status'] = ['success', 'Author Updated.', '', 3000, false];
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Rescouce</h5>
                        ...
                        <form class="row g-3" action="#" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="title" value="<?php echo $row['biography']?>" name="biography">
                                <div class="validField d-none text-danger fs-6">Field is required.</div>
                            </div>
